...
class __TwigTemplate_e7feb65b34cedb617daf65f3266a2fc8b2f62e52fbd4fd2a58822ff13442f233 extends Template
{
    private $source;
    private $macros = [];
...
yield _gettext("Disabled");
  ...
  <td>
    ";
        // line 26
        if ((0 === CoreExtension::compare(($context["type"] ?? null), "text"))) {
            // line 27
            ...
            yield "\">
    ";
        } elseif ((0 === CoreExtension::compare(        // line 28
($context["type"] ?? null), "password"))) {
    ...
    ";
        } elseif (((0 === CoreExtension::compare(        // line 30
($context["type"] ?? null), "short_text")) &&  !is_iterable(($context["value"] ?? null)))) {
            ...
            yield "\">
    ";
        } elseif ((0 === CoreExtension::compare(        // line 33
($context["type"] ?? null), "number_text"))) {
            ...
            yield "\">
    ";
        } elseif ((0 === CoreExtension::compare(        // line 35
...
($context["type"] ?? null), "select"))) {
        ...
        ";
            ...
            yield "      </select>
    ";
        } elseif ((0 === CoreExtension::compare(        // line 46
($context["type"] ?? null), "list"))) {
            ...
            foreach ($context['_seq'] as $context["key"] => $context["val"]) {
                if ((0 !== CoreExtension::compare($context["key"], "wrapper_params"))) {
                    yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($context["val"], "html", null, true);
...
";
    ...
    {
        return new Source("", "config/form_display/input.twig", "/home/sanjeetp/public_html/capitalmitra.com/wp/wp-content/plugins/wp-phpmyadmin-extension/lib/phpMyAdmin_oJl5kHayfGLbSTqdRPwKgY1/templates/config/form_display/input.twig");
    }
}
