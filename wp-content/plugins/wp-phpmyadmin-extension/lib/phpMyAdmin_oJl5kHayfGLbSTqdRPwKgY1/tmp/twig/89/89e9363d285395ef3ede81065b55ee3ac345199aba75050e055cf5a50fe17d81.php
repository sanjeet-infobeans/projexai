...
class __TwigTemplate_301442fb485c05b319dfb83d72c873a53e8e0f7d4c8bf4441998de7a2ad1ae20 extends Template
{
    private $source;
    private $macros = [];
...
yield _gettext("Wk");
  ...
  \$.datepicker.regional[''].showMonthAfterYear = ";
        // line 75
        yield (((0 === CoreExtension::compare(($context["show_month_after_year"] ?? null), "calendar-year-month"))) ? ("true") : ("false"));
        yield ";
  \$.datepicker.regional[''].yearSuffix = '";
        // line 76
        yield (((0 !== CoreExtension::compare(($context["year_suffix"] ?? null), "none"))) ? ($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(($context["year_suffix"] ?? null), "js")) : (""));
        yield "';
...
";
    ...
    {
        return new Source("", "javascript/variables.twig", "/home/sanjeetp/public_html/capitalmitra.com/wp/wp-content/plugins/wp-phpmyadmin-extension/lib/phpMyAdmin_oJl5kHayfGLbSTqdRPwKgY1/templates/javascript/variables.twig");
    }
}
