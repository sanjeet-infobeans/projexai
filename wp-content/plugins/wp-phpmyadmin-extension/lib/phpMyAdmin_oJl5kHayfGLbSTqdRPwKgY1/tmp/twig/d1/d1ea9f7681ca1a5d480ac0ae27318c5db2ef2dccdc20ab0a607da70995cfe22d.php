...
/* list_navigator.twig */
class __TwigTemplate_dabbb797906f5b8407a68a4fc0a72e072e683769fb8e5b663f44e264db3d0419 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        $macros = $this->macros;
        // line 1
        if ((-1 === CoreExtension::compare(($context["max_count"] ?? null), ($context["count"] ?? null)))) {
            // line 2
            yield "<div class=\"";
  ...
  ";
            // line 3
            if ((0 !== CoreExtension::compare(($context["frame"] ?? null), "frame_navigation"))) {
                // line 4
                yield "    ";
yield _gettext("Page number:");
  ...
  ";
            // line 7
            if ((1 === CoreExtension::compare(($context["position"] ?? null), 0))) {
                // line 8
                yield "    <a href=\"";
                ...
                yield "\"";
                yield (((0 === CoreExtension::compare(($context["frame"] ?? null), "frame_navigation"))) ? (" class=\"ajax\"") : (""));
                yield " title=\"";
...
yield _pgettext("Previous page", "Previous");
  ...
  ";
            // line 32
            if ((-1 === CoreExtension::compare((($context["position"] ?? null) + ($context["max_count"] ?? null)), ($context["count"] ?? null)))) {
                // line 33
                yield "    <a href=\"";
                yield ($context["script"] ?? null);
                yield "\" data-post=\"";
...
yield _pgettext("Next page", "Next");
    ...
    ";
                ...
                yield ($context["script"] ?? null);
                yield "\" data-post=\"";
                yield PhpMyAdmin\Url::getCommon(Twig\Extension\CoreExtension::merge(($context["url_params"] ?? null), [($context["param_name"] ?? null) => (((0 === CoreExtension::compare(($context["last_pos"] ?? null), ($context["count"] ?? null)))) ? ((($context["count"] ?? null) - ($context["max_count"] ?? null))) : (($context["last_pos"] ?? null)))]), "", false);
                yield "\"";
                yield (((0 === CoreExtension::compare(($context["frame"] ?? null), "frame_navigation"))) ? (" class=\"ajax\"") : (""));
                yield " title=\"";
...
";
    ...
    {
        return new Source("", "list_navigator.twig", "/home/sanjeetp/public_html/capitalmitra.com/wp/wp-content/plugins/wp-phpmyadmin-extension/lib/phpMyAdmin_oJl5kHayfGLbSTqdRPwKgY1/templates/list_navigator.twig");
    }
}
