...
/* header.twig */
class __TwigTemplate_32412a21d109099b08a1af938fd66a1e927fa8b4359fd87a388dda3c2810667a extends Template
{
    private $source;
    private $macros = [];
...
<head>
  ...
  <link rel=\"stylesheet\" type=\"text/css\" href=\"";
        ...
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(($context["theme_path"] ?? null), "html", null, true);
        yield "/css/theme";
        yield (((0 === CoreExtension::compare(($context["text_dir"] ?? null), "rtl"))) ? (".rtl") : (""));
        yield ".css?";
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(($context["version"] ?? null), "html", null, true);
        yield "\">
  <title>";
...
<body";
  ...
  ";
        // line 39
        if ((($context["is_menu_enabled"] ?? null) && (1 === CoreExtension::compare(($context["server"] ?? null), 0)))) {
            // line 40
            yield "    ";
  ...
  <div id=\"page_content\">
    ...
    {
        return new Source("", "header.twig", "/home/sanjeetp/public_html/capitalmitra.com/wp/wp-content/plugins/wp-phpmyadmin-extension/lib/phpMyAdmin_oJl5kHayfGLbSTqdRPwKgY1/templates/header.twig");
    }
}
