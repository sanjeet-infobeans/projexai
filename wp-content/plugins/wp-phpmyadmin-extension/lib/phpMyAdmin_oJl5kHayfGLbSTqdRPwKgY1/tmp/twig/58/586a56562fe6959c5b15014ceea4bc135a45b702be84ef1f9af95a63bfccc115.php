...
class __TwigTemplate_dc1ceac695d331704be2dacd716b3adf6fe8cd65561028a4b88ed404c91d3b95 extends Template
{
    private $source;
    private $macros = [];
...
yield _gettext("Home");
          ...
          ";
            // line 29
            if ((0 !== CoreExtension::compare(($context["server"] ?? null), 0))) {
                // line 30
                yield "            <a class=\"logout disableAjax\" href=\"";
                yield PhpMyAdmin\Url::getFromRoute("/logout");
                yield "\" title=\"";
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((((0 === CoreExtension::compare(($context["auth_type"] ?? null), "config"))) ? (_gettext("Empty session data")) : (_gettext("Log out"))), "html", null, true);
                yield "\">";
                // line 31
                yield PhpMyAdmin\Html\Generator::getImage("s_loggoff", (((0 === CoreExtension::compare(($context["auth_type"] ?? null), "config"))) ? (_gettext("Empty session data")) : (_gettext("Log out"))));
                // line 32
                yield "</a>
          ";
            }
...
yield _gettext("Reload navigation panel");
        ...
        ";
            // line 52
            if ((($context["is_servers_displayed"] ?? null) && (1 === CoreExtension::compare(Twig\Extension\CoreExtension::length($this->env->getCharset(), ($context["servers"] ?? null)), 1)))) {
                // line 53
...
";
    ...
    {
        return new Source("", "navigation/main.twig", "/home/sanjeetp/public_html/capitalmitra.com/wp/wp-content/plugins/wp-phpmyadmin-extension/lib/phpMyAdmin_oJl5kHayfGLbSTqdRPwKgY1/templates/navigation/main.twig");
    }
}
