...
/* home/index.twig */
class __TwigTemplate_11ad6e218d684d1bd49589d3393fbf2cfecb6555d806287ce1e191c1ba6a2c9c extends Template
{
    private $source;
    private $macros = [];
...
yield _gettext("General settings");
            ...
            yield "
                ";
            // line 42
            if ((1 === CoreExtension::compare(($context["server"] ?? null), 0))) {
                // line 43
                yield "                  ";
...
yield _gettext("Language");
                // line 105
                yield "                          ";
                if ((0 !== CoreExtension::compare(_gettext("Language"), "Language"))) {
                    // line 106
...
yield _gettext("License");
      ...
      ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["error"]) {
            ...
            yield (((0 === CoreExtension::compare(CoreExtension::getAttribute($this->env, $this->source, $context["error"], "severity", [], "any", false, false, false, 280), "warning"))) ? ("alert-warning") : ("alert-info"));
            yield "\" role=\"alert\">
          ";
            // line 281
            if ((0 === CoreExtension::compare(CoreExtension::getAttribute($this->env, $this->source, $context["error"], "severity", [], "any", false, false, false, 281), "warning"))) {
                // line 282
                yield "            ";
...
";
    ...
    {
        return new Source("", "home/index.twig", "/home/sanjeetp/public_html/capitalmitra.com/wp/wp-content/plugins/wp-phpmyadmin-extension/lib/phpMyAdmin_oJl5kHayfGLbSTqdRPwKgY1/templates/home/index.twig");
    }
}
