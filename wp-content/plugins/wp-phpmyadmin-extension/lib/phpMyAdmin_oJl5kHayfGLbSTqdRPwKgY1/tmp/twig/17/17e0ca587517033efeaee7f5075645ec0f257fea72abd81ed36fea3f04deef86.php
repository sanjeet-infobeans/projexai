...
class __TwigTemplate_bc506cc0e73096a24159f4511d090d9e306b8877e2cac478a7a7853282f6ae35 extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        <div class=\"card border-top-0\">
          <div class=\"card-body\">
            ...
            // line 30
            yield "              ";
            if ((is_iterable(CoreExtension::getAttribute($this->env, $this->source, $context["form"], "errors", [], "any", false, false, false, 30)) && (1 === CoreExtension::compare(Twig\Extension\CoreExtension::length($this->env->getCharset(), CoreExtension::getAttribute($this->env, $this->source, $context["form"], "errors", [], "any", false, false, false, 30)), 0)))) {
                // line 31
...
";
    ...
    {
        return new Source("", "config/form_display/display.twig", "/home/sanjeetp/public_html/capitalmitra.com/wp/wp-content/plugins/wp-phpmyadmin-extension/lib/phpMyAdmin_oJl5kHayfGLbSTqdRPwKgY1/templates/config/form_display/display.twig");
    }
}
