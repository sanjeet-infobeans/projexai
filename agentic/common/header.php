        ...
        <header class="flex items-center justify-between whitespace-nowrap border-b border-solid border-b-[#f1f2f4] px-10 py-3">
          ...
          <div class="flex flex-1 justify-end gap-8">
            <div class="flex items-center gap-9">
              <a class="text-[#121416] text-sm font-medium leading-normal" href="dashboard.php">Dashboard</a>
              <a class="text-[#121416] text-sm font-medium leading-normal" href="projects.php">Projects</a>
              <a class="text-[#121416] text-sm font-medium leading-normal" href="clients.php">Clients</a>
              <a class="text-[#121416] text-sm font-medium leading-normal" href="teams.php">Team</a>
            </div>
            <button
            ...
            >
              <span class="truncate">Welcome back, Alex</span>
            </button>
            <div
              class="bg-center bg-no-repeat aspect-square bg-cover rounded-full size-10"
              style='background-image: url("https://lh3.googleusercontent.com/aida-public/AB6AXuAhMqy4azEr8zqKaJBxVz6XaWdwxbUz9V8SZO-Gbe_BRMbfzfb5OMDECCM3lZdnuYXDTj1Leq-bySDVyFzLc5kDRnabVpnpeJgC_C-rMYJ0vU9T41F9nMpaJtp_nx7hBKNJiAWbfa8WeU9wIT0CmirN7pCJ8WlIIPwEMZed2_PaNkQ_vViMwGMNnclQNaR2TZjYCrGp-2qNMhbkO-jvkgIXaMpmgjBudIpFoQCzEKpQ_Y53016_0jlabmSjJMlOjeR3BScaxcskoW8");'
            ></div>
          </div>
        </header>